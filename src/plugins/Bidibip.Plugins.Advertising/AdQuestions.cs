...
{
    /// <summary>Thread IDs currently being regenerated by DisplayPrefilledAsync.</summary>
    private static readonly HashSet<ulong> _regeneratingThreads = [];

    public static bool IsRegenerating(ulong threadId) => _regeneratingThreads.Contains(threadId);
    ...
    public static async Task DisplayPrefilledAsync(IMessageChannel channel, AdInProgress ad, AdConfig config, IUser user)
    {
        ...
        _regeneratingThreads.Add(ad.ThreadId);
        try
        {
        ...
        {
            _regeneratingThreads.Remove(ad.ThreadId);
        }
    }
